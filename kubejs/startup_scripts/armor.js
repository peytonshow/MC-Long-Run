ItemEvents.modification(event => {
    ...
    const CHAINMAIL_HELMET_ARMOR = IRON_HELMET_ARMOR; //2;
    const CHAINMAIL_CHESTPLATE_ARMOR = IRON_CHESTPLATE_ARMOR; //5;
    const CHAINMAIL_LEGGINGS_ARMOR = IRON_LEGGINGS_ARMOR; //4;
    const CHAINMAIL_BOOTS_ARMOR = IRON_BOOTS_ARMOR; //1;
    const CHAINMAIL_TOUGHNESS = 0;
