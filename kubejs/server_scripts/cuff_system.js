...
const RESTRAINT_CONFIG = {
    tools: {
        chest: 'minecraft:gold_nugget',
        boots: 'minecraft:iron_nugget'
    },
    armor: {
        chest: 'utopia:handcuffs',
        boots: 'utopia:leg_restraints'
    },
    settings: {
        ...
        durabilityDamagePerShift: 1  // CHANGED: Now only does 1 durability damage per shift
    }
};
...
ItemEvents.entityInteracted(event => {
    try {
        ...
        console.error("Error encountered in com_restraints.js: " + error);
    }
});
...
function processStruggle(player, type, server) {
    ...
    if (newDamage >= maxDamage) {
        ...
        player.tell(Text.green('With a final burst of strength, you shattered your restraints!'));
    } else {
